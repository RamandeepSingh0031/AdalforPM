...
## 1.2 Context Management with @ Mentions
...
**What you practised:**
- Grounding AdaL in company context using `@` file mentions
- Synthesising across multiple files into a single traceable artifact
- Running a web search agent to produce a structured research output
 
## 💭**Reflection Post**
> *Were you satisfied with the output? Did AdaL's output require corrections? Still want to manage browser tabs? 😉*